...
def generate_data(prompts: dict, ddl_schema: str, user_instructions: str, temperature: float=0.7, max_tokens: int=65000, max_retries:int=3):
    """
    Facade function for generating synthetic data using the Direct retry-loop approach.
