...
def generate_data_fc(prompts:dict, ddl_schema:str, user_instructions:str, temperature:float=0.7, max_tokens:int=65000):
    """
    Function for generating synthetic data using the Function Calling approach.
