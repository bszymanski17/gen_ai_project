| Prompt | Success | Test Type |
| :--- | :---: | :--- |
| Add an employee who works in department_id=12 | 1 | **INS-DATA:** Inserting a new record linked to non existing Foreign Key. |
| Increase restaurant_id by 1 in the menu table | 1 | **MOD-FK:** Modifying a Foreign Key value in a child table. |
